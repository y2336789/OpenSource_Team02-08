...
def main():
    ...
    selectPos = selectText.get_rect(topright=loginPos.topleft)
    menuDict = {1: loginPos, 2: joinPos, 3: quitPos}
    selection = 1
    show_menu1 = False
    ...
    while inMenu:
        ...
        if not show_menu1:
            textOverlays = zip([loginText, joinText, quitText, selectText],
                               [loginPos, joinPos, quitPos, selectPos])
