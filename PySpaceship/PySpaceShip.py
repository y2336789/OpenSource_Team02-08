        ...
        if paused:
            ...
            if 0 < t < 2000:  # 블랙홀이 생성되기 전 2초까지 워닝을 표시
                ...
                for i in range(0, 5):
                    if (400 * i) < t <= (100 + (400 * i)):
                        screen.blit(warning_img1, (12, 75))
                    if (100 + (400 * i)) < t <= (200 + (400 * i)):
                        screen.blit(warning_img2, (12, 75))
                    if (200 + (400 * i)) < t <= (300 + (400 * i)):
                        screen.blit(warning_img3, (12, 75))
                    if (300 + (400 * i)) < t <= (400 + (400 * i)):
                        screen.blit(warning_img4, (12, 75))
            ...
            if 2000 <= t <= 7000:
                draw_text('소멸 시간: {}'.format(round(7 - t / 1000, 1)),
                          default_font, screen, 400, 20, MINT)
