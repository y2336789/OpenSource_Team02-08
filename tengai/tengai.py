...
#적군 무기
###################################################################
shit = pygame.image.load(os.path.join(image_path, "bullet.png"))
...
while running:
    ...
    if dragon_x>=0 and dragon_y>=0:
        ...
        dragon_speed = 5
        dragon_y = random.randrange(dragon_y - 50, dragon_y + 50)
        if dragon_x >=0:
    ...
    #shit = [[s[0] - shit_speed, s[1]] for s in shit]

    #shit = [[s[0], s[1]] for s in shit if s[0] < 0]
